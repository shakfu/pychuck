...
class TestChuckApplication:
    ...
    def test_init_with_auto_init(self, mock_get_logger, mock_chuck_class):
        ...
        # 6 params: sample_rate, output_channels, input_channels, chugin_enable,
        #           otf_enable, otf_port
        assert mock_chuck.set_param.call_count == 6
    ...
    def test_setup(self, mock_get_logger, mock_chuck_class):
        ...
        # Check set_param calls (sample_rate, output_channels, input_channels,
        # chugin_enable, otf_enable, otf_port)
