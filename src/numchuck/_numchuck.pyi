...
class ChucK:
    ...
    def set_global_associative_float_array_value(
        self, name: str, key: str, value: float
    ) -> None: ...
    ...
    def get_global_int_array_value(
        self, name: str, index: int, callback: Callable[[int], None]
    ) -> None: ...
    def get_global_float_array_value(
        self, name: str, index: int, callback: Callable[[float], None]
    ) -> None: ...
    def get_global_associative_int_array_value(
        self, name: str, key: str, callback: Callable[[int], None]
    ) -> None: ...
    def get_global_associative_float_array_value(
        self, name: str, key: str, callback: Callable[[float], None]
    ) -> None: ...
    ...
    def add_tap(
        self, name: str, num_channels: int = 1, capacity_frames: int = 8192
    ) -> None: ...
    ...
    def abort_current_shred(self) -> bool: ...
    def subscribe_shred_watcher(
        self, callback: Callable[[int, int, str], None], options: int = ...
    ) -> None: ...
    ...
    def get_adaptive(self) -> Dict[str, Any]: ...
...
# Shred watcher flags
SHRED_WATCH_NONE: int
SHRED_WATCH_SPORK: int
SHRED_WATCH_REMOVE: int
SHRED_WATCH_SUSPEND: int
SHRED_WATCH_ACTIVATE: int
SHRED_WATCH_ALL: int
